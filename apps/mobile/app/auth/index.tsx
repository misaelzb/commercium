	...
	return <CoSafeContainer style={{ flex: 1, justifyContent: "center", marginLeft: 15, marginRight: 15 }}>
		...
		<CoCard>
			{!isRegistering ? <>
				...
				<CoText>Welcome to commercium! Type your credentials to access</CoText>
				...
				<View>
					...
					<CoButton
						isLoading={isLoading}
						text="Create account" onPress={handleAuth} />
				</View>
			</>}
			<CoButton
				text={isRegistering ? "Already have one? Sign in" : "Don't have an account? Sign up"} type="secondary" onPress={() => {
