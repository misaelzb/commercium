    ...
    <View style={{ flex: 1, backgroundColor: "#f8f9fa" }}>
      <View style={{ gap: 10 }}>
        <View style={styles.row}>
          ...
          <CoCard style={{ flex: 1 }}>
            ...
            <CoText asTitle>${analytics.profit}</CoText>
          </CoCard>
        </View>
      ...
      <View style={styles.historyHeader}>
        ...
        <CoButton
          icon={"add"}
          onPress={() =>
            router.push(`/store/${sales[0].storeId}/sales/register`)
          }
        />
      </View>
      <ScrollView 
            ...
            >
              ...
              <View style={{ flex: 1, marginLeft: 12 }}>
                ...
                <CoText style={styles.saleDate}>
                  ...
                  products • {item.details.reduce((a, b) => a + b.quantity, 0)} units
                </CoText>
              </View>
              <View style={{ alignItems: "flex-end" }}>
                <Text style={styles.saleAmount}>${item.total}</Text>
              </View>
            </CoCard>)
        }
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  badgeText: { color: "#155724", fontSize: 12, fontWeight: "600" },
